        ...
        <div className="py-4">
          ...
          <div className="mt-4">
            <p className="text-sm text-muted-foreground">
              Lưu ý: File nhập vào cần có các cột: STT, Mã môn học, NMH, Mã học
              kỳ, Thứ, Tiết BĐ, Tiết KT, Phòng học, Mã giảng viên, Giảng viên,
              Ngày bắt đầu, Ngày kết thúc, Mã sinh viên
            </p>
          </div>
          <div className="mt-4">
            <Button
